...
var cri = document.querySelector('#audio-cri');
var audio_repas = document.querySelector('#audio-repas');
...
var snake_en_mouvement = function () {
    ...
    /* On vérifie la case où se trouve le snake à chacun de ses mouvements:
        ...
        - s'il est dans la zone de jeu tout va bien, s'il a la classe 'repas' c'est qu'il entre en collision avec un encas, va donc se générer un nouvel encas positionné aléatoirement dans l'area et le snake va grandir, tout comme le score du joueur d'ailleurs.
    ...
    if (span_positionDuSnake >= 0 && span_positionDuSnake <= 24 && 
        ...
        /*** Collision du snake avec lui-même ***/
